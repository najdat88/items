    ...
    public partial class Inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authClaimTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "authFeatureGroups",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authFeatureGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authFeatures", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "authFeatureValues",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authFeatureValues", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authLinkUsers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "authOrganizationUnits",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authOrganizationUnits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_authOrganizationUnits_authOrganizationUnits_ParentId",
                        column: x => x.ParentId,
                        principalTable: "authOrganizationUnits",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "authPermissionGrants",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authPermissionGrants", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "authPermissionGroups",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authPermissionGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authSecurityLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_coreAuditLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_coreSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "authOrganizationUnitRoles",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authOrganizationUnitRoles", x => new { x.OrganizationUnitId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_authOrganizationUnitRoles_authOrganizationUnits_Organizatio~",
                        column: x => x.OrganizationUnitId,
                        principalTable: "authOrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_authOrganizationUnitRoles_authRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                name: "authTenantConnectionStrings",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authTenantConnectionStrings", x => new { x.TenantId, x.Name });
                    table.ForeignKey(
                        name: "FK_authTenantConnectionStrings_authTenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authUserLogins", x => new { x.UserId, x.LoginProvider });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "authUserOrganizationUnits",
                columns: table => new
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    OrganizationUnitId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_authUserOrganizationUnits", x => new { x.OrganizationUnitId, x.UserId });
                    table.ForeignKey(
                        name: "FK_authUserOrganizationUnits_authOrganizationUnits_Organizatio~",
                        column: x => x.OrganizationUnitId,
                        principalTable: "authOrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_authUserOrganizationUnits_authUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "authUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_coreAuditLogActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_coreAuditLogActions_coreAuditLogs_AuditLogId",
                        column: x => x.AuditLogId,
                        principalTable: "coreAuditLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "coreEntityChanges",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AuditLogId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_coreEntityChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_coreEntityChanges_coreAuditLogs_AuditLogId",
                        column: x => x.AuditLogId,
                        principalTable: "coreAuditLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "coreEntityPropertyChanges",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_coreEntityPropertyChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_coreEntityPropertyChanges_coreEntityChanges_EntityChangeId",
                        column: x => x.EntityChangeId,
                        principalTable: "coreEntityChanges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_authFeatureGroups_Name",
                table: "authFeatureGroups",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authFeatures_GroupName",
                table: "authFeatures",
                column: "GroupName");

            migrationBuilder.CreateIndex(
                name: "IX_authFeatures_Name",
                table: "authFeatures",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authFeatureValues_Name_ProviderName_ProviderKey",
                table: "authFeatureValues",
                columns: new[] { "Name", "ProviderName", "ProviderKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authLinkUsers_SourceUserId_SourceTenantId_TargetUserId_Targ~",
                table: "authLinkUsers",
                columns: new[] { "SourceUserId", "SourceTenantId", "TargetUserId", "TargetTenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authOrganizationUnitRoles_RoleId_OrganizationUnitId",
                table: "authOrganizationUnitRoles",
                columns: new[] { "RoleId", "OrganizationUnitId" });

            migrationBuilder.CreateIndex(
                name: "IX_authOrganizationUnits_Code",
                table: "authOrganizationUnits",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_authOrganizationUnits_ParentId",
                table: "authOrganizationUnits",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_authPermissionGrants_TenantId_Name_ProviderName_ProviderKey",
                table: "authPermissionGrants",
                columns: new[] { "TenantId", "Name", "ProviderName", "ProviderKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authPermissionGroups_Name",
                table: "authPermissionGroups",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authPermissions_GroupName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_authRoles_NormalizedName",
                table: "authRoles",
                column: "NormalizedName");

            migrationBuilder.CreateIndex(
                name: "IX_authSecurityLogs_TenantId_Action",
                table: "authSecurityLogs",
                columns: new[] { "TenantId", "Action" });

            migrationBuilder.CreateIndex(
                name: "IX_authSecurityLogs_TenantId_ApplicationName",
                table: "authSecurityLogs",
                columns: new[] { "TenantId", "ApplicationName" });

            migrationBuilder.CreateIndex(
                name: "IX_authSecurityLogs_TenantId_Identity",
                table: "authSecurityLogs",
                columns: new[] { "TenantId", "Identity" });

            migrationBuilder.CreateIndex(
                name: "IX_authSecurityLogs_TenantId_UserId",
                table: "authSecurityLogs",
                columns: new[] { "TenantId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_authTenants_Name",
                table: "authTenants",
                column: "Name");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_authUserLogins_LoginProvider_ProviderKey",
                table: "authUserLogins",
                columns: new[] { "LoginProvider", "ProviderKey" });

            migrationBuilder.CreateIndex(
                name: "IX_authUserOrganizationUnits_UserId_OrganizationUnitId",
                table: "authUserOrganizationUnits",
                columns: new[] { "UserId", "OrganizationUnitId" });

            migrationBuilder.CreateIndex(
                name: "IX_authUserRoles_RoleId_UserId",
                table: "authUserRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_coreAuditLogActions_AuditLogId",
                table: "coreAuditLogActions",
                column: "AuditLogId");

            migrationBuilder.CreateIndex(
                name: "IX_coreAuditLogActions_TenantId_ServiceName_MethodName_Executi~",
                table: "coreAuditLogActions",
                columns: new[] { "TenantId", "ServiceName", "MethodName", "ExecutionTime" });

            migrationBuilder.CreateIndex(
                name: "IX_coreAuditLogs_TenantId_ExecutionTime",
                table: "coreAuditLogs",
                columns: new[] { "TenantId", "ExecutionTime" });

            migrationBuilder.CreateIndex(
                name: "IX_coreAuditLogs_TenantId_UserId_ExecutionTime",
                table: "coreAuditLogs",
                columns: new[] { "TenantId", "UserId", "ExecutionTime" });

            migrationBuilder.CreateIndex(
                name: "IX_coreEntityChanges_AuditLogId",
                table: "coreEntityChanges",
                column: "AuditLogId");

            migrationBuilder.CreateIndex(
                name: "IX_coreEntityChanges_TenantId_EntityTypeFullName_EntityId",
                table: "coreEntityChanges",
                columns: new[] { "TenantId", "EntityTypeFullName", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_coreEntityPropertyChanges_EntityChangeId",
                table: "coreEntityPropertyChanges",
                column: "EntityChangeId");

            migrationBuilder.CreateIndex(
                name: "IX_coreSettings_Name_ProviderName_ProviderKey",
                table: "coreSettings",
                columns: new[] { "Name", "ProviderName", "ProviderKey" },
                unique: true);
